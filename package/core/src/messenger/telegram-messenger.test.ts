    ...
    expect(genericRequest).toEqual([
      {
        ...
        chatType: "private",
        currentContext: {},
        input: { document: document, type: "telegram.document" },
        targetID: "0",
        targetPlatform: "telegram",
        telegramUser: from,
        triggerType: "message",
    ...
    expect(genericRequest).toEqual([
      {
        ...
        chatType: "private",
        currentContext: {},
        input: { images: [photo], type: "telegram.image" },
        targetID: "0",
        targetPlatform: "telegram",
        telegramUser: from,
        triggerType: "message",
    ...
    expect(genericRequest).toEqual([
      {
        ...
        chatType: "private",
        currentContext: {},
        input: { newChatMembers: [from], type: "telegram.joined_chat" },
        targetID: "0",
        targetPlatform: "telegram",
        telegramUser: from,
        triggerType: "message",
    ...
    expect(genericRequest).toEqual([
      {
        ...
        chatType: "private",
        currentContext: {},
        input: { leftChatMembers: [from], type: "telegram.left_chat" },
        targetID: "0",
        targetPlatform: "telegram",
        telegramUser: from,
        triggerType: "message",
    ...
    expect(genericRequest).toEqual([
      {
        ...
        chatType: "private",
        currentContext: {},
        input: { video, type: "telegram.video" },
        targetID: "0",
        targetPlatform: "telegram",
        telegramUser: from,
        triggerType: "message",
